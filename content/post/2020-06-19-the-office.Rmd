...
Phyllis is the cast MVP, based on this model. The high values for "Everyone" and "All" show that scenes where the entire office is involved are highly associated with increased ratings. Carell's directorship is significantly more important than the other directors. The model has a dim view of Nellie and the later seasons of the show in general. The negative importance for Roy clearly means that the model is internally valid and cannot be improved upon.
