...
Note: high-res images of the main graphs from this post are available ![here](/post/2019-11-11-analyzing-commuter-patterns-in-allegheny-county_files/p1.png), ![here](/post/2019-11-11-analyzing-commuter-patterns-in-allegheny-county_files/p2.png), ![here](/post/2019-11-11-analyzing-commuter-patterns-in-allegheny-county_files/p3.png), and ![here](/post/2019-11-11-analyzing-commuter-patterns-in-allegheny-county_files/p4.png).
...
```{r}
geo_crosswalk <- read_csv("data/lodes/pa_xwalk.csv.gz", col_types = cols(.default = "c"))
...
```{r}
df <- read_csv("data/lodes/pa_od_main_JT00_2015.csv.gz", col_types = cols(.default = "c")) %>% 
