...
#view data
cv_eval_lm %>% 
  select(id, validate_mae, validate_rmse)
```
...
rmse(model, testing_data)
mae(model, testing_data)
rsquare(model, testing_data)
```
These plots show how the model performed against the testing data.
```{r}
