...
```{r}
##load transit data
transit_lines <- st_read("commuter_route_transit_availability/shapefiles/transit_lines/PAAC_Routes_1909.shp") %>%
  clean_names() %>%
...
```{r}
transit_stops <- st_read("commuter_route_transit_availability/shapefiles/transit_stops/PAAC_Stops_1909.shp") %>%
  st_transform(3488) %>% 
  clean_names() %>% 
